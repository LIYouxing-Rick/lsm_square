...
parser.add_argument('--corr-method', default='olm', type=str,
                    help='correlation method: olm or lsm')
...
def main():
    ...
    if args.benchmark.startswith('ILSVRC2012') or args.benchmark.startswith('imagenet'):
        ...
        train_dataset = Cub2011(args.data, train=True, transform=train_transforms,download=False)
        val_dataset = Cub2011(args.data, train=False, transform=val_transforms,download=False)
    ...
    if not args.distributed or dist.get_rank() == 0:
        try:
            ...
            with open(os.path.join(outdir, 'best_acc.txt'), 'a') as f:
                f.write(
                    'benchmark={}; arch={}; representation={}; correlation={}; corr_method={}; log_method={}; log_order={}; max_iter={}; epochs={}; lr={}; batchsize={}; modeldir={}; best@50={:.3f}; best@100={:.3f}; best@all={:.3f}\n'.format(
                        args.benchmark, args.arch, args.representation, args.correlation, args.corr_method, args.log_method, args.log_order, args.max_iter, args.epochs, args.lr, args.batch_size, args.modeldir, best_prec1_50, best_prec1_100, best_prec1))
